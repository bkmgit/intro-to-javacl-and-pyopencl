...
script_dir = os.path.dirname(__file__)  # __file__ is the full path to this script
with open(os.path.join(script_dir, "../resources/matmul.cl"), "r") as vadd:
    kernelsource = vadd.read()
